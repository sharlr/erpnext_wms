// Live totals as items are entered. import_file.py recomputes the same figures
// on validate() and stays authoritative on save.
//
// Customer, Company, Shipping Line and AWB/BL come from fetch_from on the
// doctype, so they populate as soon as File Number is picked.

frappe.ui.form.on("Import Item", {
...
function calculate_totals(frm) {
	const rows = frm.doc.import_items || [];
