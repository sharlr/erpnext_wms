...
// Only boot on the standalone visualization page. This script is also reachable
// from the desk, where neither THREE nor the canvas element exists.
document.addEventListener('DOMContentLoaded', () => {
	...
	if (typeof THREE === 'undefined') {
		console.error('erpnext_wms: three.js failed to load, 3D view unavailable');
		return;
	}
